...
public class GameManager : MonoBehaviour
{
	...
	public Transform statMenu, mainMenu, shopMenu, invenMenu, deadMenu, vilShop, vilInven;

	private bool a = true, b = true;

	public string name;

	public int health, hunger, closeness, cocky, skin, count, scene;
    ...
    public void vilshopM(bool c)
    {
        vilShop.gameObject.SetActive(c);
    }

    public void vilInvenM(bool c)
    {
        vilInven.gameObject.SetActive(c);
    }
